      ...
      <div class="header-main-wrapper">
        ...
        <div class="header-inner">
          ...
          if ($user->uid != 0):
            ...
            <?php if (in_array('Giáo viên', $role) || in_array('administrator', $role) || in_array('Sales', $role)): ?>
              ...
              <nav class="menu-primary">
                <ul class="menu-primary__container">
                  <li><a href="/dieu-khoan-tro-thanh-giao-vien"
                         class="btn btn-primary"><span>Trở thành giáo viên</span></a>
                  </li>
                </ul>
              </nav>
            </div>
            ...
            <?php else: ?>
              <div class="header-avatar">
                ...
                <ul class="box-management">
                  <li class="item">
                    <i class="fal fa-money-check-alt fa-fw me-2"></i> Số dư:
                    <span class="text-red">0 đ</span>
                  </li>
                  <li class="item">
                    <i class="fal fa-file-certificate fa-fw me-2"></i>
                    <a href="#">Tài liệu đã mua</a>
                  </li>
                  <li class="item">
                    <i class="fal fa-file-check fa-fw me-2"></i> <a href="#">Tài
                      liệu đã xem</a>
                  </li>
                  <li class="item">
                    <i class="fal fa-university fa-fw me-2"></i> <a href="#">Quản
                      lý hoa hồng</a>
                  </li>
                  <li class="item">
                    <i class="fal fa-wallet fa-fw me-2"></i> <a href="#">Quản lý
                      thu nhập - rút tiền</a>
                  </li>
                  <li class="item">
                    <i class="fal fa-history fa-fw me-2"></i> <a href="#">Lịch
                      sử giao dịch</a>
                  </li>
                  <li class="item">
                    <i class="fal fa-user fa-fw me-2"></i> <a href="#">Thông tin
                      cá nhân</a>
                  </li>
                  <li class="item">
              ...
              <div class="col-md-6">
                <div class="can_deu">
                  <a href="/user/<?= $user->uid ?>/edit"
                     class="btn btn-primary"><span>Chỉnh sửa thông tin <i
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="dashboard-profile__item">
                    <div class="dashboard-profile__heading"><h4>Họ và tên:</h4>
                    </div>
                  ...
                  <div class="dashboard-profile__item">
                    <div class="dashboard-profile__heading"><h4>Số điện thoại:</h4></div>
                    <div class="dashboard-profile__content">
                      <p><?php isset($user->field_so_dien_thoai['und'][0]['value']) ? print $user->field_so_dien_thoai['und'][0]['value'] : print 'Đang cập nhật' ?></p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="dashboard-profile__item">
                    <div class="dashboard-profile__heading"><h4>Cấp học:</h4>
                    </div>
                    <div class="dashboard-profile__content">
                      <p><?php isset($user->field_cap_hoc['und'][0]['value']) ? print $user->field_cap_hoc['und'][0]['value'] : print 'Đang cập nhật'; ?></p>
                    </div>
                  </div>
                  <div class="dashboard-profile__item">
                    <div class="dashboard-profile__heading"><h4>Ngày đăng
                        ký:</h4></div>
                    <div class="dashboard-profile__content">
      ...
      <div class="footer-section px-4">
            ...
            <div class="col-lg-12">
              ...
              <div class="footer-widget">
                <div class="footer-widget__info">
                  <p><i class="fas fa-phone-alt fa-fw"></i> <strong>Hỗ trợ kinh
                      doanh:</strong> <a
                      href="tel:0906044866">0906.044.866</a> (24/24)</p>
                  <p><i class="fas fa-phone-alt fa-fw"></i><strong> Hỗ trợ kỹ
                      thuật:</strong> <a
                      href="tel:0982563365">0982.563.365</a> (24/24)</p>
                  <p><i class="fas fa-map-marker-alt fa-fw"></i> <strong>VP Hà
                      Nội</strong>: Tầng 9 , tòa nhà Diamond Flower, Số nhà 48,
                    Ðường Lê Văn Lương, Phường Nhân Chính, Quận Thanh Xuân,
                    Thành phố Hà Nội, Việt Nam</p>
                  <p><i class="fas fa-map-marker-alt fa-fw"></i> <strong>VP Hồ
                      Chí Minh</strong>: Lầu 6 tòa nhà Bcons - 4A/167A Nguyễn
                    Văn Thương, Phường 25, quận Bình Thạnh, TP Hồ Chí Minh</p>
                </div>
        ...
        <div class="footer-copyright">
          <div class="copyright-wrapper text-center">
            <p class="footer-widget__copyright mt-0">© Công Ty Cổ Phần Giáo Dục
              Chuẩn</p>
          </div>
        </div>
        <!-- Footer Copyright Area End -->
