...
<div
  ...
  <main class="dashboard-main-wrapper <?php
  global $user;
  if (isset($user->roles[4])) print 'giao_vien';
  ?>">
        ...
        <div class="row gy-10">
          ...
          <div class="col-lg-<?= $cls ?>">
            ...
            <div class="box-content">
              <?php if ((arg(0) == 'quan-ly-de-thi') && isset($user->uid) && (isset($user->roles[4]) || isset($user->roles[3]))): ?>
                <p class="text-right mb-0">
                  <button type="button" class="btn btn-add-node"
                          data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <i class="fa fa-plus"></i>Tạo đề thi
                  </button>
                </p>
                <div class="modal fade dethi_form " id="exampleModal" tabindex="-1"
