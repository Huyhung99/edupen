          ...
          <div class="header-navigation d-none d-xl-block">
            <nav class="menu-primary">
              <ul class="menu-primary__container">
                <li><a href="/dieu-khoan-tro-thanh-giao-vien" class="btn btn-primary"><span>Trở thành giáo viên</span></a></li>
              </ul>
            </nav>
          </div>
          <?php endif;?>
            ...
            <?php else:?>
              <div class="header-avatar">
                ...
                <ul class="box-management">
                  <li class="item">
                    <i class="fal fa-money-check-alt fa-fw me-2" ></i> Số dư: <span class="text-red">0 đ</span>
                  </li>
                  <li class="item">
                  ...
                  <li class="item">
                    <i class="fal fa-file-check fa-fw me-2"></i> <a href="#">Tài liệu đã xem</a>
                  </li>
                  <li class="item">
                    <i class="fal fa-university fa-fw me-2"></i> <a href="#">Quản lý hoa hồng</a>
                  </li>
                  <li class="item">
                    <i class="fal fa-wallet fa-fw me-2"></i> <a href="#">Quản lý thu nhập - rút tiền</a>
                  </li>
                  <li class="item">
                    <i class="fal fa-history fa-fw me-2"></i> <a href="#">Lịch sử giao dịch</a>
                  </li>
                  <li class="item">
                    <i class="fal fa-user fa-fw me-2"></i> <a href="#">Thông tin cá nhân</a>
                  </li>
                  <li class="item">
                    <i class="fal fa-sign-out fa-fw me-2"></i> <a href="/user/logout">Đăng xuất</a>
                  </li>
                </ul>
              </div>
            <?php endif;?>
  ...
  <main class="dashboard-main-wrapper">
    ...
    <div class="dashboard-content">
      <div class="container-fluid">
                        ...
                        <div class="dashboard-info__card">
                            <a class="dashboard-info__card-box" href="#">
                                ...
                                <div class="dashboard-info__card-content">
                                    <div class="dashboard-info__card-value"><?=views_embed_view('block_front','block_2')?></div>
                                    <div class="dashboard-info__card-heading">Tài liệu đã đăng</div>
                                </div>
                            </a>
                        </div>
        ...
        <?php else:?>
        <p>Vui lòng <a href="/user">đăng nhập</a> trước khi vào</p>
        <?php endif;?>
      </div>
    </div>
